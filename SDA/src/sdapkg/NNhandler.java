...
public class NNhandler {
    ...
    public boolean train() {
        ...
        try {
            ...
            Process p = Runtime.getRuntime().exec("Python\\Python35\\python ΝΝ.py \"" + Arg1 + "\" \"" + Arg2 + "\" \"" + Arg3 + "\"");
    ...
    public String predict() {
        ...
        try {
            ...
            Process p = Runtime.getRuntime().exec("Python\\Python35\\python predict.py \"" + Arg1 + "\" \"" + Arg4 + "\"");
            BufferedReader stdInput = new BufferedReader(new InputStreamReader(p.getInputStream()));
            while (p.isAlive()) {
    ...
    public String Generalpredict() {
        ...
        try {
            ...
            Process p = Runtime.getRuntime().exec("Python\\Python35\\python GeneralPredict.py \"" + Arg5 + "\" \"" + Arg6 + "\"");
            BufferedReader stdInput = new BufferedReader(new InputStreamReader(p.getInputStream()));
